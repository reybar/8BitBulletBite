...
public class WeaponPickup : NetworkBehaviour {
    ...
    void Start() {
        if(transform.Find("Weapon pivot").Find("Weapon")) {
            weaponPosition = transform.Find("Weapon pivot").Find("Weapon");
        }
    }
    ...
    private void OnTriggerStay2D(Collider2D coll) {
        ...
        if(weapon1 == null) {  //TODO tu dodati kod izrade novih weapona
            if(coll.tag == "Pistol") {
                CmdEquipWeapon(1, 1);
                //slot1 = 1;
